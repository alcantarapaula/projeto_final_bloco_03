    ...
    <>
      ...
      >
        ...
        >
          ...
          <img src="https://ik.imagekit.io/paula/logofarmacia.png" alt="Logo Farmácia" className="hidden sm:block max-h-12" />
          <img src="https://ik.imagekit.io/paula/faviconfarmacia.png" alt="Logo Farmácia" className="sm:hidden max-h-8 sm:max-h-12" />
          </Link>
            <div className="max-md:hidden flex items-center gap-0.5 md:gap-2 p-0 w-1/4 md:w-1/3">
              <input
                type="text"
